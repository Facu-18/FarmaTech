        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanalContacto = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ventas_Empleadas_IdEmpleada",
                        column: x => x.IdEmpleada,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IngresosMercaderia_Droguerias_IdDrogueria",
                        column: x => x.IdDrogueria,
                        principalTable: "Droguerias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngresosMercaderia_Empleadas_IdEmpleada",
                        column: x => x.IdEmpleada,
                        principalTable: "Empleadas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngresosMercaderia_Productos_IdProducto",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotasPedido_Droguerias_IdDrogueria",
                        column: x => x.IdDrogueria,
                        principalTable: "Droguerias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotasPedido_Empleadas_IdEmpleada",
                        column: x => x.IdEmpleada,
                        principalTable: "Empleadas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotasPedido_Productos_IdProducto",
                        column: x => x.IdProducto,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngresosMercaderia_IdEmpleada",
                table: "IngresosMercaderia",
                column: "IdEmpleada");

            migrationBuilder.CreateIndex(
                name: "IX_IngresosMercaderia_IdProducto",
                table: "IngresosMercaderia",
                column: "IdProducto");

            migrationBuilder.CreateIndex(
                name: "IX_NotasPedido_IdDrogueria",
                table: "NotasPedido",
                column: "IdDrogueria");

            migrationBuilder.CreateIndex(
                name: "IX_NotasPedido_IdEmpleada",
                table: "NotasPedido",
                column: "IdEmpleada");

            migrationBuilder.CreateIndex(
                name: "IX_NotasPedido_IdProducto",
                table: "NotasPedido",
                column: "IdProducto");

            migrationBuilder.CreateIndex(
                name: "IX_Ventas_IdEmpleada",
                table: "Ventas",
                column: "IdEmpleada");
        }
